...
export default class Acomodation extends Component {
  ...
  render() {
    return (
      ...
      <Picker
           ...
           <Picker.Item label="Apartment With Rooms" value="Apartment With Rooms" />
           <Picker.Item label="Collective Accomodation" value="Collective Accomodation" />
